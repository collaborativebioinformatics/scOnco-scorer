...
#' Log loss (cross-entropy). Required by METHODS.md §8 alongside Brier.
#' Probabilities are clamped away from 0 and 1, since a confident wrong call
#' would otherwise return Inf and destroy any aggregate it enters.
